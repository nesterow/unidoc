...
var _require = require('../../config/browser'),
    CACHE_ASSETS = _require.CACHE_ASSETS,
    CACHE_PAGES = _require.CACHE_PAGES;

var __ALL__ = [].concat(_toConsumableArray(CACHE_ASSETS), _toConsumableArray(CACHE_PAGES));
...
var isPage = function isPage(string) {
  return CACHE_PAGES.filter(function (e) {
    ...
    return cache.match(event.request).then(function (response) {
      ...
      if (response && isPage(event.request.url)) {
        ...
        return response.text().then(function (text) {
          ...
          return cache.addAll(CACHE_PAGES.filter(function (page) {
